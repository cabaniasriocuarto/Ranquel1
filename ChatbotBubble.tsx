    ...
    <div id="chatbot-container">
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "10px", borderBottom: "1px solid var(--border)", paddingBottom: "8px" }}>
              <span style={{ fontWeight: "bold", color: "var(--foreground)" }}>Asistente Ranquel</span>
              <button onClick={() => setIsOpen(false)} style={{ background: "none", border: "none", color: "var(--muted-foreground)", cursor: "pointer" }}>✕</button>
            </div>
            ...
            <div style={{ height: "300px", overflowY: "auto", display: "flex", flexDirection: "column", gap: "8px" }}>
              ...
              {loading && <div style={{ color: "var(--muted-foreground)", fontSize: "11px", marginLeft: "8px" }}>Escribiendo...</div>}
